...
-------
    ...
    04_Figures/step05a_spectral_index_distribution.pdf
    04_Figures/Inspect/step05a_sed_thermal.pdf
    04_Figures/Inspect/step05a_sed_uncertain.pdf
    04_Figures/Inspect/step05a_sed_steep.pdf
    04_Figures/Inspect/step05a_sed_no_reliable_alpha.pdf
...
DETECTED_FILE = os.path.join(OUTS, "step04c_hash_status_all.vot")
MKT5_FILE = os.path.join(DATA, "MeerKAT_Final_5sigma.vot")
OUT_VOT = os.path.join(OUTS, "step05a_spectral_index.vot")
FIG_HIST = os.path.join(FIGS, "step05a_spectral_index_distribution.pdf")
...
print("step05a: fitting spectral indices")
...
for category in ["thermal", "uncertain", "steep", "no_reliable_alpha"]:
    ...
    output = os.path.join(INSP, f"step05a_sed_{category}.pdf")
