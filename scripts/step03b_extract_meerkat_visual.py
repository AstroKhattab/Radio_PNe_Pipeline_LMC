"""
step03b_extract_meerkat_visual.py
=================================
...
Outputs
-------
    03_Outputs/step03b_meerkat_visual.vot — Catalogue with fluxes
    04_Figures/Inspect/step03b_meerkat_visual_beams.pdf — Cutouts for verification

After verifying cutouts, run
step04a_build_meerkat_catalogue_and_multisurvey_figures.py to merge.
...
OUT_VOT   = os.path.join(OUTS, "step03b_meerkat_visual.vot")
OUT_PDF   = os.path.join(INSP, "step03b_meerkat_visual_beams.pdf")
...
print("step03b: extracting MeerKAT fluxes for the visual detections")
...
print("\n[1] Loading step03a_meerkat_to_check.vot...")
    ...
    with fits.open(path) as h:
        for hdu in h:
            if hdu.data is not None and len(hdu.data.shape) >= 2:
                d = np.squeeze(hdu.data).astype(float)
...
print(f"\n[4] Writing step03b_meerkat_visual.vot...")
...
print("\n  Verify cutouts then run: python "
      "02_Scripts/step04a_build_meerkat_catalogue_and_multisurvey_figures.py")
