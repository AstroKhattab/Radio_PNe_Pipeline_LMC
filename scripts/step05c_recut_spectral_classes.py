...
Inputs
    03_Outputs/step05a_spectral_index.vot   fitted alpha_combined and its
                                            error, reduced chi-square and
                                            number of flux points (225 rows).
    03_Outputs/step06b_confidence.vot       joined by RP_ID for the Cohen
...
Output
    03_Outputs/step05c_spectral_index_recut.vot  all input columns plus
...
SPECTRAL_INDEX_FILE = os.path.join(OUTDIR, "step05a_spectral_index.vot")
CONFIDENCE_FILE = os.path.join(OUTDIR, "step06b_confidence.vot")
OUTPUT_FILE = os.path.join(OUTDIR, "step05c_spectral_index_recut.vot")
