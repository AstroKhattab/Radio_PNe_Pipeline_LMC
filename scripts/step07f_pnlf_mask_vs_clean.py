...
Input   03_Outputs/step07a_pnlf.vot, 03_Outputs/step05a_spectral_index_recut.vot
Output  04_Figures/step07f_pnlf_mask_vs_clean.pdf
...
fig.savefig(f'{B}/04_Figures/step07f_pnlf_mask_vs_clean.pdf')
print("A  M*=%.3f  chi2red=%.2f"%(po[1],rc))
print("B  M*=%.3f  chi2red=%.2f"%(po2[1],rc2))
print("C  M*=%.3f  chi2red=%.2f"%(poc[1],rcc))
print("saved step07f_pnlf_mask_vs_clean.pdf")
