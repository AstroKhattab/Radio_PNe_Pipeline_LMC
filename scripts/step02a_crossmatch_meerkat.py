...
Inputs (01_Data/)
-----------------
    03_Outputs/step01a_reid_master.vot — Unified Reid catalogue from Step 01a
...
Outputs
-------
    03_Outputs/step02a_meerkat_matched.vot    — Matched sources + MeerKAT columns
    03_Outputs/step02a_meerkat_unmatched.vot  — Unmatched sources
    04_Figures/step02a_meerkat_offsets.pdf    — Positional offset QC (hexbin)
...
OUT_MATCHED   = os.path.join(OUTS, "step02a_meerkat_matched.vot")
OUT_UNMATCHED = os.path.join(OUTS, "step02a_meerkat_unmatched.vot")
FIG_OFFSETS   = os.path.join(FIGS, "step02a_meerkat_offsets.pdf")
...
print("step02a: cross-matching Reid against MeerKAT 1.295 GHz")
