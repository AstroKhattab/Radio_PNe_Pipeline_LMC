...
Outputs
-------
    03_Outputs/step5a_confidence.vot
    05_Figures/step5a_confidence_summary.pdf
...
INPUT_FILE = os.path.join(OUTS, "step4b_mir_radio_ratio.vot")
OUT_VOT = os.path.join(OUTS, "step5a_confidence.vot")
FIGURE = os.path.join(FIGS, "step5a_confidence_summary.pdf")

os.makedirs(OUTS, exist_ok=True)
os.makedirs(FIGS, exist_ok=True)

print("step5a: assigning PN confidence grades")
